  ...
  return (
    <div className="projects-container fade-in">
      <div className="breadcrumb-nav">
        <button onClick={() => navigate('/user/user-dashboard')} className="btn-link-crumb">Back to dashboard</button> 
        <span className="crumb-sep">/</span> 
        <button onClick={() => navigate('user/user-upcoming-interview')} className="btn-link-crumb">Upcoming Interviews</button>
        <span className="crumb-sep">/</span>
        <span className="crumb-active">Schedule Interview</span>
      </div>
