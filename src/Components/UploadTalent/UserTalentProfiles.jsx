...
import { FiGrid, FiList, FiSearch, FiBriefcase, FiRefreshCw } from "react-icons/fi";
        ...
        <div className="p-4 pt-0 d-flex flex-column gap-3">
              ...
              <button
                ...
                onClick={() => {
                  if (selectedIds.size === 0) {
                    toast.error("Please select talent in order to publish.");
                    return;
                  }
          ...
          <div className="d-flex gap-3">
            <section className="vs-results">
              ...
              {/* No Data */}
              {!isLoading && !isToggling && sortedCandidates.length === 0 && (
                <div
                  style={{
                    padding: "40px",
                    width: "100%",
              ...
              {isToggling ? (
                <div className="jobs-screen-loader" style={{ height: "400px" }}>
                  <div className="jobs-loader-ring">
                    <div className="jobs-loader-icon">
