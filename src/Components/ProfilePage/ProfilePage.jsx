...
const ProfilePage = () => {
  ...
  const companyData = apiData
    ? {
      ...
      size: "100-200",
      status: "Active",
      industry: apiData.role === "Recruiter" ? "Hiring Manager" : apiData.role === "Benchsales" ? "Bench Sales" : apiData.role,
      ...
      role: apiData.role === "Recruiter" ? "Hiring Manager" : apiData.role === "Benchsales" ? "Bench Sales" : apiData.role,
